...
#The appropriate operators the function will accept are addition and subtraction. Multiplication
#and division will return an error. Other operators not mentioned in this bullet point will not need to be tested.
...
#1. gräns på 5 stycken siffror [X]
#2. operatörer  för plus minus multiplikation
# indetermiate strings för whitespaces strip()
# räkna funnktioner på linjer  för problemet  0-3 så rad 1 , rad2 (+- int) (whitespaces/s ), linjen(str) , summan( rad+rad2)
